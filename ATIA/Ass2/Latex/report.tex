...
Throughout this assignment we will use image A (\autoref{A}) and image B (\autoref{B}) to measure similarity. Both image have been downsampled and then blurred with a Gaussian kernel with sigma being 1.
\begin{figure}[h]
	\centering
...
\input{Exercises/selfSimilarity}
\input{Exercises/multiModal}
\input{Exercises/object}
\input{Exercises/registration}
\input{Exercises/conclusion}
